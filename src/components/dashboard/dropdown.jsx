...
//         {/* Main button */}
//         <div
//           className="w-full h-[100px] bg-white shadow-2xl backdrop-blur-md bg-opacity-80 px-4 py-3 rounded-2xl text-center text-2xl font-bold text-white bg-[#1f2937] cursor-pointer transition-transform duration-300 hover:scale-110 hover:bg-[#374151] flex items-center justify-center"
...
//               setOpenMenu(false);
//             }}
//             className="w-full h-[60px] bg-gradient-to-r from-purple-600 to-pink-600 text-white text-center px-5 py-4 rounded-2xl shadow-lg cursor-pointer backdrop-blur-md bg-opacity-90 transition-all duration-300 hover:scale-105 hover:brightness-110 flex items-center justify-center text-lg"
//           >
//             Jira
//           </div>
...
//               setOpenMenu(false);
//             }}
//             className="w-full h-[60px] bg-gradient-to-r from-pink-600 to-yellow-600 text-white text-center px-5 py-4 rounded-2xl shadow-lg cursor-pointer backdrop-blur-md bg-opacity-90 transition-all duration-300 hover:scale-105 hover:brightness-110 flex items-center justify-center text-lg"
//           >
...
//               setOpenMenu(false);
//             }}
//             className="w-full h-[60px] bg-gradient-to-r from-blue-600 to-teal-500 text-white text-center px-5 py-4 rounded-2xl shadow-lg cursor-pointer backdrop-blur-md bg-opacity-90 transition-all duration-300 hover:scale-105 hover:brightness-110 flex items-center justify-center text-lg"
//           >
//             SVN
//           </div>
//         </div>
